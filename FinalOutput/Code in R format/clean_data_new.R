...
write.csv(unifiedTblSingle, "Results/unifiedMLData_time.csv", row.names = FALSE)
...
write.csv(unifiedTblMulti, "Results/unifiedMLDataMulti_time.csv", row.names = FALSE)
